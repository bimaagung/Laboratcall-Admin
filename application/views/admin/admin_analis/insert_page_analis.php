   ...
   <div class="row-fluid">
    ...
    <div class="block">
      <div class="navbar navbar-inner block-header">
        <div class="muted pull-left"><?php echo $labelanalis;?></div>
      </div>
      <div class="block-content collapse in">
        ...
        <?php 
          ...
          ?>
          <form  method="post" action="<?php echo base_url();?>index.php/admin/page_analis/save_analis" enctype="multipart/form-data" class="form-horizontal">
            <fieldset>
          <div class="control-group" style="margin-top:50px;" align="center">
              ...
              <div class="form-actions">
                ...
                <a type="button" class="btn" href="<?php echo base_url(); ?>index.php/admin/page_analis">Kembali</a>
              </div>
            </fieldset>
          </form>
