 ...
 <div class="row-fluid">
  ...
  <div class="block">
    <div class="navbar navbar-inner block-header">
      <div class="muted pull-left">Daftar Pasien</div>
    </div>

    <!-- <ul class="nav nav-tabs">
      <li class="active"><a data-toggle="tab" href="#pasien">Pasien</a></li>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Tampil data pasien</h4>
      </div>
      <div class="modal-body">
        <table id="view_data_pasien"  class="table table-striped table-bordered">
          <!-- View Tabel -->
        </table>
      </div>
...
$('#view_data_pasien').on('click','.delete_pasien',function(){
