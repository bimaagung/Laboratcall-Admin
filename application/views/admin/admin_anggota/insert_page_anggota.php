   ...
   <div class="row-fluid">
    ...
    <div class="block">
      <div class="navbar navbar-inner block-header">
        <div class="muted pull-left"><?php echo $labelanggota;?></div>
      </div>
      <div class="block-content collapse in">
        <div class="span12">
          <form  method="post" action="<?php echo base_url();?>index.php/admin/page_anggota/save_anggota" enctype="multipart/form-data" class="form-horizontal">
            <fieldset>
              ...
              <div class="form-actions">
                ...
                <button type="reset" class="btn" onclick="window.location='http://localhost/silari/index.php/admin/page_anggota'">Kembali</button>
              </div>
            </fieldset>
          </form>
