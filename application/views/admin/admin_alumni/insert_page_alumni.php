   ...
   <div class="row-fluid">
    ...
    <div class="block">
      <div class="navbar navbar-inner block-header">
        <div class="muted pull-left"><?php echo $labelalumni;?></div>
      </div>
          ...
          <form  method="post" action="<?php echo base_url();?>index.php/admin/page_alumni/save_alumnus" enctype="multipart/form-data" class="form-horizontal">
            <fieldset>
              ...
              <div class="form-actions">
                ...
                <button type="reset" class="btn" onclick="window.location='http://localhost/silari/index.php/admin/page_alumni'">Kembali</button>
              </div>
            </fieldset>
          </form>
